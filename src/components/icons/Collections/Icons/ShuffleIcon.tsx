...
export const ShuffleIcon = (props: SvgProps) => (
    <Svg
        ...
        {...props}
        fill={props.color}>
        <Path d="m23.421 16.583-3.291-3.291a1 1 0 1 0-1.413 1.414L21.007 17a9.332 9.332 0 0 1-6.686-2.8.982.982 0 0 0-1.408.08l-.013.02a1 1 0 0 0 .075 1.382A11.177 11.177 0 0 0 21.01 19l-2.293 2.293A1 1 0 1 0 20.13 22.7l3.291-3.291a2 2 0 0 0 0-2.826Z" />
